      ...
      <CommonPageStyles>
        ...
        <ul>
          <li>
            ...
            <BrandFont>neuromatch conference</BrandFont>
            using your email, Gmail, or GitHub handle.
            <br />
            <StyledImg
          ...
          <li>
            ...
            <BrandFont noAfterSpace>neuromatch conferences</BrandFont>
            , you still have to
            {' '}
            ...
            <BrandFont noAfterSpace>neuromatch 3.0 conference</BrandFont>
            .
          </li>
          <li>
            After signing up, provide basic information about you, including
            your abstracts if you want to participate in the
            <BrandFont>mind-matching</BrandFont>
            (1-on-1 matching) part of the conference.
          </li>
          <li>
          ...
          <li>
            ...
            {' '}
            <a href="/your-matches">your matches</a>
            {' '}
        ...
        <p>
          ...
          {' '}
          <EmphasizedText>
            The registration fee is $25 per person and a
            fee waiver is available
          </EmphasizedText>
          {' '}
          for those who cannot have their fee covered by
          either their institution, company, or lab and cannot pay on their own
          (no validation necessary) or lack the technical means to use our
          payment portal. Consistent with our values of making the meeting
          accessible as possible, we have minimizedthe cost to attend while
          still providing the financial support necessary to increase the scope
          and impact of the meeting beyond previous offerings. With the fee
          waiver, we want to explicitly guarantee that no one is unable to
          participate due to funding status.
          <StyledImg
        ...
        <p>
          We use machine learning algorithm to match conference attendees together
          for one-on-one meeting, so called &quot;mind-matching&quot;. To sign up,
          opt-in to the matching part to matching part in your registration
          profile and provide us your representative abstract.
          <StyledImg
            src={require('../../../static/instructions/mind-match-reg.png')}
            alt="profile"
          />
        </p>
        <h3>Mind-Matching Prepartion</h3>
        <ol>
          <li>
            <h4>Preparation</h4>
            <ol type="a">
              <li>
                ...
                partners on
                {' '}
                <Link to="/your-matches">
                  your matches page
                </Link>
                {' '}
                a few days after the registration ends. You will get
                who your partners are and suggestions on how to e-meet them
                before, during, or after the main conference.
              </li>
              <li>
                You can exchange emails with your match partners to organize
                a time and meeting platforms (Skype/Zoom/etc.) beforehand. Please
          ...
          <li>
            <h4>Before the meeting with your match</h4>
            <ol type="a">
              <li>
        ...
        <p>
          ...
          {' '}
          first. If you cannot find your solution, you can contact us at
          {' '}
          <code>
            nmc@neuromatch.io
          </code>
