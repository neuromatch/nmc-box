...
const Banner = styled.div`
  ...
  box-shadow: 0em -0.15em 0.15em #ddd;
  z-index: 9999;
`;
...
Button.defaultProps = {
  ...
  hoverColor: '#eee',
  hoverBgColor: '#444',
  activeBgColor: 'rgba(50,50,50,0.2)',
};
...
const CookieBanner = () => {
  ...
  return (
    <Banner>
      <Container padBottom>
        <Text>
          This website or its third-party tools process personal data (e.g. log-in
          ...
          illustrated in the cookie policy.
        </Text>
        <Text>
          You accept the use of cookies or other
          identifiers by closing or dismissing this notice, by clicking a link or
          button or by continuing to browse otherwise.
        </Text>
        <ButtonsBlock>
          <StyledLink to="/cookie">
            Learn more
          </StyledLink>
